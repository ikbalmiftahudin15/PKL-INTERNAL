<template>
  ...
  <div v-else>
    <div class="w-fit mx-auto grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 justify-items-center justify-center gap-y-20 gap-x-14 mt-20 mb-5">
      <div v-for="product in getProduk.slice(1,4)" :key="product.slug">
        <div
        ...
        >
          <a href="#">
            <img
              ...
              src="https://cf.shopee.co.id/file/93c0fac70b325d766f306c3c31798d75"
              alt="product image"
            />
          </a>
          <span
